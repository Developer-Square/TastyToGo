...
class MessageScreenWidget extends StatefulWidget {
  const MessageScreenWidget({Key? key}) : super(key: key);
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    10.0, 17.0, 10.0, 17.0),
                                            child: Text(
                                              'Hola Roronoa, donde estas ahora?',
                                              style:
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  image: DecorationImage(
                                    fit: BoxFit.cover,
                                    image: Image.asset(
                                      'assets/images/portrait-african-american-man_1.png',
                                    ).image,
                                  ),
                                  shape: BoxShape.circle,
                                ),
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    10.0, 17.0, 10.0, 17.0),
                                            child: Text(
                                              'Hola Ryan, estoy a 15 minutos de tu casa?',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
                                            ...
                                            child: Padding(
                                              padding: EdgeInsetsDirectional
                                                  .fromSTEB(
                                                      10.0, 17.0, 10.0, 17.0),
                                              child: Text(
                                                'Ay muy bueno, estoy muy hambriento',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyMedium
                                                        .override(
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    10.0, 17.0, 10.0, 17.0),
                                            child: Text(
                                              'Haha, me aseguraré de que tu comida llegue a ti',
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                                      .override(
